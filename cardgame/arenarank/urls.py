...
urlpatterns = patterns('',
 ...
 url(r'^infiection_prestige_award', 'arenarank.views.infiection_prestige_award'),
 url(r'^infection_get_battle', 'arenarank.views.infection_get_battle'),
 url(r'^infection_battle_award', 'arenarank.views.infection_battle_award'), 
 url(r'^infection_ladder', 'arenarank.views.infection_ladder'),
 url(r'^infection_info', 'arenarank.views.infection_info'),
 url(r'^infection_prestige_award', 'arenarank.views.infection_prestige_award'),
 url(r'^infection_reset_prestige_score', 'arenarank.views.infection_reset_prestige_score'),
)